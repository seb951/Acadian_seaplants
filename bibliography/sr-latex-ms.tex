%This is a latex template I took from https://github.com/svmiller/svm-r-markdown-templates and made some minor modifications to%
%Sebastien Renaut - February 2019%
...
\hypersetup{breaklinks=true,
	    ...
	    pdfsubject = {$if(runningtitle)$$runningtitle$$endif$},
...
\vskip 8.5pt \noindent \emph{RunningTitle}: $runningtitle$ \par
